...
MainWindow::MainWindow(int width, int height) :
    TgMainWindow(width, height, "TestButton", width-200, height-200, width+200, height+200),
    m_button0(this, 0, 5, 5, 5, 0),
    m_button1(this, 5, 5, 5, 5, 1),
    m_button2(this, 0, 50, 20, 20, 2),
    m_button3(this, 10, 50, 20, 20, 3),
    m_button4(this, 0, 100, 40, 20, 4),
    m_button4on0(this, &m_button4, 10, 0, 30, 20, 5),
    m_button4on1(this, &m_button4on0, 10, 0, 20, 20, 6)
{
}
