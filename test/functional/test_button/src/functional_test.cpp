        ...
        for (i=0;i<m_testOrders.getOrdersCount();i++) {
            switch (m_testOrders.getTestOrder(i)->m_type) {
                ...
                case isHoverCount:
                    ...
                    break;
                case setVisibleItem:
                    m_mainWindow->getButton( m_testOrders.getTestOrder(i)->m_listNumber.at(0) )->setVisible( m_testOrders.getTestOrder(i)->m_listNumber.at(1) );
                    break;
                ...
                case isVisible:
                    ...
                    break;
                case setEnabledItem:
                    m_mainWindow->getButton( m_testOrders.getTestOrder(i)->m_listNumber.at(0) )->setEnabled( m_testOrders.getTestOrder(i)->m_listNumber.at(1) );
                    break;
                case isEnabled:
                    if (!isCorrectEnabled(
                                        m_testOrders.getTestOrder(i)->m_listNumber.at(0),
