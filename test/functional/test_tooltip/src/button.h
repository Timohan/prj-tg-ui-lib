...
class Button : public TgButton
{
public:
    Button(MainWindow *mainWindow, float x, float y, float width, float height, size_t index);
    Button(MainWindow *mainWindow, TgItem2d *parent, float x, float y, float width, float height, size_t index);
